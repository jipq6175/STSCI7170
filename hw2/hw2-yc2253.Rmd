...
According to the definition of t-distribution, we can write

$$\frac{(\bar{Y}_{1.} - \bar{Y}_{2.})^2/ \sigma^2(\frac{1}{n_1}+\frac{1}{n_2})}{\frac{1}{\sigma^2}(S_1^2+S_2^2)/(n_1+n_2-2)} = \frac{(\bar{Y}_{1.} - \bar{Y}_{2.})^2/ (\frac{1}{n_1}+\frac{1}{n_2})}{(S_1^2+S_2^2)/(n_1+n_2-2)} \sim T_{n_1+n_2-2}(\mu_1-\mu_2)$$
