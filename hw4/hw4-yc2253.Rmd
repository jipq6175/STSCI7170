...
for $j\neq k$ because of the properties of the Hlmert matrix. Therefore, $\hat{\gamma_j}$ and $\hat{\gamma_k}$ are independent.
...
$$\hat{\gamma}_{BLUE} = \left( \frac{1-\rho}{t-\rho}\right)\hat{\gamma_1} + \left( \frac{t-1}{t-\rho}\right)\hat{\gamma_j} \quad j = 2,3, \dots, t$$

### 3d

For $\rho \to 1$, 

$$\hat{\gamma}_{BLUE} = \hat{\gamma_j}$$
